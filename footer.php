            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="cybersecurite" class="hover:text-white transition duration-300">Cybersécurité</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="apropos" class="hover:text-white transition duration-300">À propos</a></li>
                        <li><a href="index#contact" class="hover:text-white transition duration-300">Contact</a></li>
